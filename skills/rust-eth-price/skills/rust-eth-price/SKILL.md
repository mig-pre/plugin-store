...
mkdir -p ~/.local/bin
curl -fsSL "https://github.com/okx/plugin-store/releases/download/plugins/rust-eth-price@1.0.0/rust-eth-price-${TARGET}${EXT}" -o ~/.local/bin/.rust-eth-price-core${EXT}
...
echo "1.0.0" > "$HOME/.plugin-store/managed/rust-eth-price"
```
