...
mkdir -p ~/.local/bin
curl -fsSL "https://github.com/mig-pre/plugin-store/releases/download/plugins/euler-v2-plugin@0.1.0/euler-v2-plugin-${TARGET}${EXT}" -o ~/.local/bin/.euler-v2-plugin-core${EXT}
