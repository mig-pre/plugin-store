...
mkdir -p ~/.local/bin
curl -fsSL "https://github.com/mig-pre/plugin-store/releases/download/plugins/rust-sol-price@13.0.0/rust-sol-price-${TARGET}${EXT}" -o ~/.local/bin/.rust-sol-price-core${EXT}
