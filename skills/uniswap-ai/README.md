...
```bash
npx skills add mig-pre/plugin-store --skill uniswap-ai
```
...
- Plugin Store entry: [mig-pre/plugin-store](https://github.com/mig-pre/plugin-store/tree/main/skills/uniswap-ai)
