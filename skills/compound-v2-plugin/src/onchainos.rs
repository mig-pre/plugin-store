...
///     in the common case.
///   - EVM-015: explicit gas_limit override. Compound V2 cToken ops trigger
///     interest accrual + COMP distribution side-effects — onchainos auto-estimate
///     under-shoots for first-tx-of-block flows. Use 250k for simple writes,
///     400k+ for borrow / repayBorrow / claimComp (which iterate cTokens).
