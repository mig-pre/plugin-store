...
BIN_TMP=$(mktemp -d)
RELEASE_BASE="https://github.com/mig-pre/plugin-store/releases/download/plugins/pancakeswap-v3-plugin@1.0.4"
...
curl -fsSL "${RELEASE_BASE}/checksums.txt" -o "$BIN_TMP/checksums.txt" || {
  echo "ERROR: failed to download checksums.txt for pancakeswap-v3-plugin@1.0.4" >&2
  rm -rf "$BIN_TMP"; exit 1; }
