...
| `category` | Yes | Plugin category | One of: `strategy`, `defi`, `game`, `prediction`, `data_tools`, `dev_tools`, `others`, `utility`, `trading` |
...
```python
# ✅ Correct — trading operation with --strategy-id
